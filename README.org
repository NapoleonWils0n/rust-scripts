...
#+begin_src sh
sha256sum -c nixos-rust-scripts-v1.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: nixos-rust-scripts-v1.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf nixos-rust-scripts-v1.tar.gz
#+end_src
...
#+begin_src sh
sha256sum -c linux-rust-scripts-v1.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: linux-rust-scripts-v1.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf linux-rust-scripts-v1.tar.gz
#+end_src
