...
[[https://github.com/NapoleonWils0n/rust-scripts/releases][https://img.shields.io/github/downloads/NapoleonWils0n/ffmpeg-rust-scripts/total.svg?style=flat-square&color=blue]]
[[https://github.com/NapoleonWils0n/rust-scripts/stargazers][https://img.shields.io/github/stars/NapoleonWils0n/ffmpeg-rust-scripts.svg?style=flat-square&color=blue]]
[[https://github.com/NapoleonWils0n/rust-scripts/blob/master/LICENSE][https://img.shields.io/github/license/NapoleonWils0n/ffmpeg-rust-scripts.svg?style=flat-square&color=blue]]
...
#+begin_src sh
sha256sum -c nixos-rust-scripts-v2.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: nixos-rust-scripts-v2.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf nixos-rust-scripts-v2.tar.gz
#+end_src
...
#+begin_src sh
sha256sum -c linux-rust-scripts-v2.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: linux-rust-scripts-v2.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf linux-rust-scripts-v2.tar.gz
#+end_src
...
#+begin_src sh
mv build rust-scripts-build-v2
#+end_src

Change into the rust-scripts-build-v2 directory

#+begin_src sh
cd rust-scripts-build-v2
#+end_src
...
#+begin_src sh
mv linux linux-rust-scripts-v2
#+end_src

nixos

#+begin_src sh
mv nixos nixos-rust-scripts-v2
#+end_src
...
#+begin_src sh
rm -i linux-rust-scripts-v2/rust_scripts
#+end_src

NixOS

#+begin_src sh
rm -i nixos-rust-scripts-v2/rust_scripts
#+end_src
...
#+begin_src sh
tar -czvf linux-rust-scripts-v2.tar.gz linux-rust-scripts-v2
#+end_src

***** nixos

#+begin_src sh
tar -czvf nixos-rust-scripts-v2.tar.gz nixos-rust-scripts-v2
#+end_src
...
#+begin_src sh
mv *-rust-scripts-v[0-9]*.tar.gz release-files-v2/
#+end_src

**** create checksums for the archives

change directory into the release-files-v2 directory
...
#+begin_src sh
sha256sum linux-rust-scripts-v2.tar.gz > linux-rust-scripts-v2.tar.gz.sha256
#+end_src

***** nixos

#+begin_src sh
sha256sum nixos-rust-scripts-v2.tar.gz > nixos-rust-scripts-v2.tar.gz.sha256
#+end_src
