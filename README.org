...
[[https://github.com/NapoleonWils0n/rust-scripts/releases][https://img.shields.io/github/downloads/NapoleonWils0n/rust-scripts/total.svg?style=flat-square&color=blue]]
[[https://github.com/NapoleonWils0n/rust-scripts/stargazers][https://img.shields.io/github/stars/NapoleonWils0n/rust-scripts.svg?style=flat-square&color=blue]]
[[https://github.com/NapoleonWils0n/rust-scripts/blob/master/LICENSE][https://img.shields.io/github/license/NapoleonWils0n/rust-scripts.svg?style=flat-square&color=blue]]
...
Record PipeWire audio with duration in filename
...
Usage: record-pipewire [OPTIONS]

Options:
  -o <PREFIX>    Optional prefix [default: pipewire]
  -h, --help     Print help
  -v, --version  Print version
#+end_example
...
Example output for a 30 second recording using the default output file name

#+begin_example
pipewire-[00:00:30].wav
#+end_example

Using the -o option you can change the output file name prefix

#+begin_src sh
record-pipewire -o youtube
#+end_src

Output

#+begin_example
youtube-[00:00:30].wav
#+end_example
...
[[https://github.com/NapoleonWils0n/rust-scripts/releases]]
...
#+begin_src sh
sha256sum -c nixos-rust-scripts-v3.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: nixos-rust-scripts-v3.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf nixos-rust-scripts-v3.tar.gz
#+end_src
...
#+begin_src sh
sha256sum -c linux-rust-scripts-v3.tar.gz.sha256
#+end_src

#+begin_example
Expected Output: linux-rust-scripts-v3.tar.gz: OK
#+end_example
...
#+begin_src sh
tar -xf linux-rust-scripts-v3.tar.gz
#+end_src
...
#+begin_src sh
ldd target/x86_64-unknown-linux-musl/release/record-pipewire
#+end_src
...
#+begin_src sh
mv build rust-scripts-build-v3
#+end_src

Change into the rust-scripts-build-v3 directory

#+begin_src sh
cd rust-scripts-build-v3
#+end_src
...
#+begin_src sh
mv linux linux-rust-scripts-v3
#+end_src

nixos

#+begin_src sh
mv nixos nixos-rust-scripts-v3
#+end_src
...
#+begin_src sh
rm -i linux-rust-scripts-v3/rust_scripts
#+end_src

NixOS

#+begin_src sh
rm -i nixos-rust-scripts-v3/rust_scripts
#+end_src
...
#+begin_src sh
tar -czvf linux-rust-scripts-v3.tar.gz linux-rust-scripts-v3
#+end_src

***** nixos

#+begin_src sh
tar -czvf nixos-rust-scripts-v3.tar.gz nixos-rust-scripts-v3
#+end_src
...
#+begin_src sh
mv *-rust-scripts-v[0-9]*.tar.gz release-files-v3/
#+end_src

**** create checksums for the archives

change directory into the release-files-v3 directory
...
#+begin_src sh
sha256sum linux-rust-scripts-v3.tar.gz > linux-rust-scripts-v3.tar.gz.sha256
#+end_src

***** nixos

#+begin_src sh
sha256sum nixos-rust-scripts-v3.tar.gz > nixos-rust-scripts-v3.tar.gz.sha256
#+end_src
